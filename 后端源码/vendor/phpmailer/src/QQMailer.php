...
class QQMailer
{
    public static $HOST = 'smtp.gmail.com'; // 163 邮箱的服务器地址
    public static $PORT = '465'; // smtp 服务器的远程服务器端口号
    public static $SMTP = 'ssl'; // 使用 ssl 加密方式登录
    public static $CHARSET = 'UTF-8'; // 设置发送的邮件的编码

    private static $USERNAME = 'easycarsvip@gmail.com'; // 授权登录的账号
    private static $PASSWORD = 'rysjtivsaceytywq'; // 授权登录的密码
    private static $NICKNAME = 'Easycars'; // 发件人的昵称
